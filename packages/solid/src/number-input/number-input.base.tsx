...
export const NumberInputRoot: Component<ArkNumberInput.RootProps> = (props) => {
  const [local, others] = splitProps(props, ["class"]);
  return <ArkNumberInput.Root class={styles.root({ class: local.class })} {...others} />;
};

export const NumberInputLabel: Component<ArkNumberInput.LabelProps> = (props) => {
  const [local, others] = splitProps(props, ["class"]);
  return <ArkNumberInput.Label class={styles.label({ class: local.class })} {...others} />;
};

export const NumberInputControl: Component<ArkNumberInput.ControlProps> = (props) => {
  const [local, others] = splitProps(props, ["class"]);
  return <ArkNumberInput.Control class={styles.control({ class: local.class })} {...others} />;
};

export const NumberInputInput: Component<ArkNumberInput.InputProps> = (props) => {
  const [local, others] = splitProps(props, ["class"]);
  return <ArkNumberInput.Input class={styles.input({ class: local.class })} {...others} />;
};

export const NumberInputIncrementTrigger: Component<ArkNumberInput.IncrementTriggerProps> = (
  props,
) => {
  const [local, others] = splitProps(props, ["class"]);
  return (
...
export const NumberInputDecrementTrigger: Component<ArkNumberInput.DecrementTriggerProps> = (
  props,
) => {
  const [local, others] = splitProps(props, ["class"]);
  return (
...
export const NumberInputScrubber: Component<ArkNumberInput.ScrubberProps> = (props) => {
  const [local, others] = splitProps(props, ["class"]);
  return <ArkNumberInput.Scrubber class={styles.scrubber({ class: local.class })} {...others} />;
};

export const NumberInputTriggerGroup: Component<HTMLProps<"div">> = (props) => {
  const [local, others] = splitProps(props, ["class"]);
  return <div class={styles.triggerGroup({ class: local.class })} {...others} />;
};

export const NumberInputValueText: Component<ArkNumberInput.ValueTextProps> = (props) => {
  const [local, others] = splitProps(props, ["class"]);
