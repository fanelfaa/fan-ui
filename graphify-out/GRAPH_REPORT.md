...
## Corpus Check
- Large corpus: 316 files · ~82,871 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 1928 nodes · 1828 edges · 200 communities (188 shown, 12 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 3 edges (avg confidence: 0.77)
- Token cost: 0 input · 0 output

## Community Hubs (Navigation)
- [[_COMMUNITY_Core Styling Recipes|Core Styling Recipes]]
- [[_COMMUNITY_Component Demos|Component Demos]]
- [[_COMMUNITY_Project Documentation|Project Documentation]]
- [[_COMMUNITY_Select & ScrollArea|Select & ScrollArea]]
- [[_COMMUNITY_Select Component Docs|Select Component Docs]]
- [[_COMMUNITY_HoverCard Docs|HoverCard Docs]]
- [[_COMMUNITY_TagsInput Docs|TagsInput Docs]]
- [[_COMMUNITY_SegmentGroup Docs|SegmentGroup Docs]]
- [[_COMMUNITY_Combobox Docs|Combobox Docs]]
- [[_COMMUNITY_RatingGroup Docs|RatingGroup Docs]]
- [[_COMMUNITY_RadioGroup Docs|RadioGroup Docs]]
- [[_COMMUNITY_DatePicker Docs|DatePicker Docs]]
- [[_COMMUNITY_Button Docs|Button Docs]]
- [[_COMMUNITY_Listbox Docs|Listbox Docs]]
- [[_COMMUNITY_Tooltip Docs|Tooltip Docs]]
- [[_COMMUNITY_Accordion Docs|Accordion Docs]]
- [[_COMMUNITY_TagsInput Implementation Plan|TagsInput Implementation Plan]]
- [[_COMMUNITY_Tabs Docs|Tabs Docs]]
- [[_COMMUNITY_Toggle Docs|Toggle Docs]]
- [[_COMMUNITY_ToggleGroup Docs|ToggleGroup Docs]]
- [[_COMMUNITY_Input & Password Docs|Input & Password Docs]]
- [[_COMMUNITY_PinInput Docs|PinInput Docs]]
- [[_COMMUNITY_Pagination Docs|Pagination Docs]]
- [[_COMMUNITY_Toast Docs|Toast Docs]]
- [[_COMMUNITY_Drawer Docs|Drawer Docs]]
- [[_COMMUNITY_Breadcrumb Docs|Breadcrumb Docs]]
- [[_COMMUNITY_Slider Docs|Slider Docs]]
- [[_COMMUNITY_Switch Docs|Switch Docs]]
- [[_COMMUNITY_NumberInput Docs|NumberInput Docs]]
- [[_COMMUNITY_Textarea Docs|Textarea Docs]]
- [[_COMMUNITY_Progress Docs|Progress Docs]]
- [[_COMMUNITY_ColorPicker Docs|ColorPicker Docs]]
- [[_COMMUNITY_Table Docs|Table Docs]]
- [[_COMMUNITY_Alert Docs|Alert Docs]]
- [[_COMMUNITY_Dialog Docs|Dialog Docs]]
- [[_COMMUNITY_Checkbox Docs|Checkbox Docs]]
- [[_COMMUNITY_Separator Docs|Separator Docs]]
- [[_COMMUNITY_Popover Docs|Popover Docs]]
- [[_COMMUNITY_Collapsible Docs|Collapsible Docs]]
- [[_COMMUNITY_Avatar Docs|Avatar Docs]]
- [[_COMMUNITY_Skeleton Docs|Skeleton Docs]]
- [[_COMMUNITY_Spinner Docs|Spinner Docs]]
- [[_COMMUNITY_Typography Docs|Typography Docs]]
- [[_COMMUNITY_AlertDialog Docs|AlertDialog Docs]]
- [[_COMMUNITY_AspectRatio Docs|AspectRatio Docs]]
- [[_COMMUNITY_Badge Docs|Badge Docs]]
- [[_COMMUNITY_Card Docs|Card Docs]]
- [[_COMMUNITY_ScrollArea Docs|ScrollArea Docs]]
- [[_COMMUNITY_Pagination Implementation Plan|Pagination Implementation Plan]]
- [[_COMMUNITY_ColorPicker Implementation Plan|ColorPicker Implementation Plan]]
- [[_COMMUNITY_RatingGroup Implementation Plan|RatingGroup Implementation Plan]]
- [[_COMMUNITY_Breadcrumb Implementation Plan|Breadcrumb Implementation Plan]]
- [[_COMMUNITY_Listbox Implementation Plan|Listbox Implementation Plan]]
- [[_COMMUNITY_HoverCard Implementation Plan|HoverCard Implementation Plan]]
- [[_COMMUNITY_Table Implementation Plan|Table Implementation Plan]]
- [[_COMMUNITY_Pagination Implementation|Pagination Implementation]]
- [[_COMMUNITY_Core Recipes Index|Core Recipes Index]]
- [[_COMMUNITY_Solid.js Components Index|Solid.js Components Index]]
- [[_COMMUNITY_Panel & Carousel Positions|Panel & Carousel Positions]]
- [[_COMMUNITY_Panel & Dialog Positions|Panel & Dialog Positions]]
- [[_COMMUNITY_Dialog & Carousel Positions|Dialog & Carousel Positions]]
- [[_COMMUNITY_CLI Implementation|CLI Implementation]]
...
1. `Solid.js` - 113 edges
2. `tailwind-variants (tv)` - 47 edges
3. `Select` - 12 edges
4. `Combobox` - 10 edges
5. `Button` - 10 edges
6. `Artifact Checklist` - 10 edges
7. `PROJECT KNOWLEDGE BASE` - 9 edges
8. `Accordion` - 9 edges
9. `Artifact Checklist` - 9 edges
10. `Artifact Checklist` - 9 edges

## Surprising Connections (you probably didn't know these)
- `shadcn` --conceptually_related_to--> `@ui/solid`  [INFERRED]
  COMPONENT_TODOS.md → packages/solid/AGENTS.md
- `SelectRootProviderDemo()` --calls--> `Select()`  [INFERRED]
  apps/docs/src/components/select-demo/SelectRootProviderDemo.tsx → packages/solid/src/select/index.tsx
- `@ui/core` --depends_on--> `tailwind-variants (tv)`  [EXTRACTED]
  packages/core/AGENTS.md → AGENTS.md
- `@ui/solid` --depends_on--> `Ark UI`  [EXTRACTED]
  packages/solid/AGENTS.md → AGENTS.md
- `@ui/solid` --depends_on--> `Solid.js`  [EXTRACTED]
  packages/solid/AGENTS.md → AGENTS.md
...
### Community 16 - "TagsInput Implementation Plan"
Cohesion: 0.08
...
### Community 22 - "Input & Password Docs"
Cohesion: 0.09
...
### Community 25 - "Toast Docs"
Cohesion: 0.1
Nodes (20): API Reference, CLI, code:tsx (import {), code:tsx (import { createSignal } from "solid-js";), code:tsx (import { useDialog } from "@ark-ui/solid/dialog";), code:bash (npx solidui-cli@latest add dialog), code:bash (npm install tailwind-variants), code:tsx (import { tv, type VariantProps } from 'tailwind-variants') (+12 more)

### Community 26 - "Drawer Docs"
Cohesion: 0.1
...
### Community 28 - "Slider Docs"
Cohesion: 0.1
Nodes (19): API Reference, Checkbox, CLI, code:tsx (import { Checkbox, CheckboxLabel, CheckboxRootProvider } fro), code:tsx (<Checkbox disabled />), code:tsx (<Checkbox checked="indeterminate" />), code:tsx (import { useCheckbox } from "@ark-ui/solid/checkbox";), code:bash (npx solidui-cli@latest add checkbox) (+11 more)

### Community 29 - "Switch Docs"
Cohesion: 0.1
...
### Community 35 - "Table Docs"
Cohesion: 0.11
Nodes (18): API Reference, CLI, code:tsx (import {), code:tsx (import { useCollapsible } from "@ark-ui/solid/collapsible";), code:bash (npx solidui-cli@latest add collapsible), code:bash (npm install tailwind-variants), code:tsx (import { tv, type VariantProps } from 'tailwind-variants'), code:tsx (import { Collapsible as ArkCollapsible } from "@ark-ui/solid) (+10 more)

### Community 36 - "Alert Docs"
Cohesion: 0.11
...
### Community 37 - "Dialog Docs"
Cohesion: 0.11
Nodes (18): API Reference, CLI, code:tsx (import {), code:tsx (<Slider defaultValue={[50]} disabled>), code:bash (npx solidui-cli@latest add slider), code:bash (npm install tailwind-variants), code:tsx (import { tv, type VariantProps } from 'tailwind-variants'), code:tsx (import { Slider as ArkSlider } from "@ark-ui/solid/slider";) (+10 more)

### Community 38 - "Checkbox Docs"
Cohesion: 0.11
...
### Community 39 - "Separator Docs"
Cohesion: 0.12
Nodes (3): Content(), Item(), useListboxVariant()

### Community 40 - "Popover Docs"
Cohesion: 0.11
...
### Community 51 - "Pagination Implementation Plan"
Cohesion: 0.12
Nodes (16): API Reference, CLI, code:tsx (import {), code:bash (npx solidui-cli@latest add popover), code:bash (npm install tailwind-variants), code:tsx (import { tv, type VariantProps } from 'tailwind-variants'), code:tsx (import { Popover as ArkPopover } from '@ark-ui/solid/popover), code:tsx (import { Popover as ArkPopover } from "@ark-ui/solid/popover) (+8 more)

### Community 52 - "ColorPicker Implementation Plan"
Cohesion: 0.12
...
### Community 53 - "RatingGroup Implementation Plan"
Cohesion: 0.12
...
### Community 54 - "Breadcrumb Implementation Plan"
Cohesion: 0.12
...
### Community 55 - "Listbox Implementation Plan"
Cohesion: 0.12
...
### Community 56 - "HoverCard Implementation Plan"
Cohesion: 0.12
...
### Community 57 - "Table Implementation Plan"
Cohesion: 0.12
...
### Community 58 - "Pagination Implementation"
Cohesion: 0.12
...
### Community 62 - "Panel & Carousel Positions"
Cohesion: 0.12
...
### Community 63 - "Panel & Dialog Positions"
Cohesion: 0.13
...
### Community 64 - "Dialog & Carousel Positions"
Cohesion: 0.13
...
### Community 71 - "Monorepo Structure"
Cohesion: 0.21
...
## Knowledge Gaps
- **758 isolated node(s):** `OVERVIEW`, `code:block1 (.)`, `WHERE TO LOOK`, `CODE MAP`, `CONVENTIONS` (+753 more)
...
- **Why does `Solid.js` connect `Component Demos` to `Select & ScrollArea`, `DatePicker Ark Parts`, `Menu Ark Parts`, `Carousel Docs`, `Community 162`, `Community 163`, `Community 164`, `Community 165`, `Community 166`, `Community 167`, `Community 168`, `Community 169`, `Community 170`, `Community 171`, `Separator Docs`, `Package & Build Config`, `Solid Component Base Parts`, `CLI Implementation`, `Docs App Config`, `Accordion RootProvider`, `Combobox Interaction`, `Architecture Docs`, `Monorepo Structure`, `Community 72`, `Community 73`, `Community 74`, `Community 75`, `Community 76`, `Community 77`, `Community 78`, `Community 79`, `Community 82`, `Community 83`, `Community 86`, `Community 87`, `Community 88`, `Community 93`, `Community 94`, `Community 95`, `Community 96`, `Community 97`, `Community 98`, `Community 99`, `Community 100`, `Community 101`, `Community 102`, `Community 103`, `Community 104`, `Community 105`, `Community 106`, `Community 107`, `Community 110`?**
  _High betweenness centrality (0.085) - this node is a cross-community bridge._
- **Why does `@ui/solid` connect `Monorepo Structure` to `Component Demos`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
- **Why does `@ui/core` connect `Monorepo Structure` to `Core Styling Recipes`?**
...
- **Should `Core Styling Recipes` be split into smaller, more focused modules?**
  _Cohesion score 0.04 - nodes in this community are weakly interconnected._
- **Should `Component Demos` be split into smaller, more focused modules?**
  _Cohesion score 0.04 - nodes in this community are weakly interconnected._
