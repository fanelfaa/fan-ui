...
Cohesion: 0.09
Nodes (20): API Reference, Avatar Placeholder, Card Skeleton, CLI, code:tsx (import { Skeleton } from "~/components/skeleton";), code:tsx ({/_ Circle for avatars _/}), code:bash (npx solidui-cli@latest add skeleton), code:bash (npm install tailwind-variants) (+12 more)
