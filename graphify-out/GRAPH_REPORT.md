# Graph Report - ui  (2026-06-08)

## Corpus Check
- 303 files · ~82,775 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1992 nodes · 1905 edges · 190 communities (178 shown, 12 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 10 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `37892114`
...
5. `Dialog` - 11 edges
6. `Button` - 11 edges
7. `PROJECT KNOWLEDGE BASE` - 10 edges
8. `Accordion` - 10 edges
9. `Artifact Checklist` - 10 edges
10. `Number Input` - 9 edges
...
- `DialogRootProviderDemo()` --calls--> `Dialog`  [INFERRED]
  apps/docs/src/components/dialog-demo/DialogRootProviderDemo.tsx → apps/docs/src/content/docs/components/dialog.mdx
...
Cohesion: 0.1
Nodes (17): API Reference, CLI, code:tsx (import {), code:bash (npx solidui-cli@latest add popover), code:bash (npm install tailwind-variants), code:tsx (import { tv, type VariantProps } from 'tailwind-variants'), code:tsx (import { Popover as ArkPopover } from '@ark-ui/solid/popover), code:tsx (import { Popover as ArkPopover } from "@ark-ui/solid/popover) (+9 more)
...
- **Why does `Solid.js` connect `Community 0` to `Community 3`, `Community 5`, `Community 10`, `Community 21`, `Community 22`, `Community 154`, `Community 155`, `Community 156`, `Community 157`, `Community 158`, `Community 159`, `Community 39`, `Community 51`, `Community 62`, `Community 65`, `Community 66`, `Community 67`, `Community 68`, `Community 69`, `Community 70`, `Community 71`, `Community 72`, `Community 73`, `Community 74`, `Community 75`, `Community 76`, `Community 77`, `Community 78`, `Community 81`, `Community 82`, `Community 83`, `Community 86`, `Community 91`, `Community 92`, `Community 93`, `Community 94`, `Community 95`, `Community 96`, `Community 97`, `Community 98`, `Community 99`, `Community 100`, `Community 101`, `Community 102`, `Community 103`, `Community 104`, `Community 105`, `Community 106`, `Community 107`?**
  _High betweenness centrality (0.087) - this node is a cross-community bridge._
- **Why does `@ui/solid` connect `Community 71` to `Community 0`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **Why does `@ui/core` connect `Community 71` to `Community 1`?**
  _High betweenness centrality (0.007) - this node is a cross-community bridge._
- **Are the 2 inferred relationships involving `Dialog` (e.g. with `AlertDialogDeleteDemo()` and `DialogRootProviderDemo()`) actually correct?**
  _`Dialog` has 2 INFERRED edges - model-reasoned connections that need verification._
