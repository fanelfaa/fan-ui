...
import { children, createSignal, type ParentProps, Show, onMount, onCleanup, splitProps } from "solid-js";

const MAX_HEIGHT = 200;

export default function CodeBlock(props: ParentProps<Pick<HTMLPreElement, 'className' | 'classList'|'style'>>) {
