...
```tsx
import { Collapsible, CollapsibleRootProvider, CollapsibleTrigger, CollapsibleContent, CollapsibleIndicator } from "~/components/collapsible"
...
import { CollapsibleTrigger, CollapsibleContent, CollapsibleIndicator, CollapsibleRootProvider } from "~/components/collapsible"
