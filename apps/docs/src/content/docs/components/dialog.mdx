...
```tsx
import { Dialog, DialogRootProvider, DialogTrigger, DialogContent, DialogHeader, DialogFooter, DialogTitle, DialogDescription } from "~/components/dialog"
...
export { DialogRoot as Dialog, DialogRootProvider, DialogTrigger, DialogContent, DialogHeader, DialogFooter, DialogTitle, DialogDescription, dialogVariants }
```
</div>
...
<DialogRootProviderDemo client:only="solid-js" />

```tsx
import { useDialog } from "@ark-ui/solid/dialog"
import { DialogRootProvider, DialogTrigger, DialogContent, DialogHeader, DialogFooter, DialogTitle, DialogDescription } from "~/components/dialog"
import { Button } from "~/components/button"
  ...
  return (
    <div>
      ...
      <DialogRootProvider value={dialog}>
        <DialogTrigger asChild={(p: any) => <Button {...p} style="display:none" />}>
          Hidden Trigger
        </DialogTrigger>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              This dialog is controlled via useDialog.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
...
| Prop | Type | Default | Description |
|------|------|---------|-------------|
| value | `UseDialogReturn` | — | Context returned by `useDialog()`. **Required.** |
| lazyMount | `boolean` | `false` | Whether to enable lazy mounting. |
| unmountOnExit | `boolean` | `false` | Whether to unmount on exit. |
| present | `boolean` | — | Whether the node is present (controlled). |
| immediate | `boolean` | — | Whether to synchronize present change immediately. |
