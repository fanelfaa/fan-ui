...
> **Dependencies:** This component imports shared recipes or sub-components from other packages. Make sure the following are also installed: [label](/docs/components/label), [scroll-area](/docs/components/scroll-area).
